...
class MultiHeadAttention(nn.Module):
    ...
    def __init__(self, n_head, d_model, d_k, d_v, dropout=0.1):
        ...
        self.w_qs = nn.Parameter(torch.Tensor(n_head, d_model, d_k))
        self.w_ks = nn.Parameter(torch.Tensor(n_head, d_model, d_k))
        self.w_vs = nn.Parameter(torch.Tensor(n_head, d_model, d_v))
